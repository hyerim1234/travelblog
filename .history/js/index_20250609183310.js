...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const tabPanels = document.querySelectorAll('#travelTabContent > [role="tabpanel"]');
  ...
  tabButtons.forEach((btn) => {
    btn.addEventListener("click", function () {
      ...
      // 4. 선택된 패널만 보이기
      const selector = this.getAttribute('data-tabs-target');
  ...
  // 최초 국내여행 탭 클릭!
  document.getElementById('domestic-tab').click();
});
